        ...
        if isinstance(key, bytes):
            ...
            try:
                try:
                    ...
                    key = load_pem_private_key(key, ***REMOVED***None, backend=self.cryptography_backend())
        ...
        if isinstance(key, bytes):
            try:
                ...
                try:
                    ...
                    self.prepared_key = load_pem_private_key(key, ***REMOVED***None, backend=self.cryptography_backend())
            except Exception as e:
                raise JWKError(e)
            return
