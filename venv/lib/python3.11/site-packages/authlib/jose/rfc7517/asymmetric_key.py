...
class AsymmetricKey(Key):
    ...
    def as_bytes(self, encoding=None, is_private=False, ***REMOVED***None):
    ...
    def as_pem(self, is_private=False, ***REMOVED***None):
        return self.as_bytes(is_private=is_private, ***REMOVED***password)

    def as_der(self, is_private=False, ***REMOVED***None):
        return self.as_bytes(encoding="DER", is_private=is_private, ***REMOVED***password)
    ...
    def import_key(cls, raw, options=None):
        ...
        if isinstance(raw, cls.PUBLIC_KEY_CLS):
            ...
            if options is not None:
                ...
                password = None
            raw_key = load_pem_key(raw, cls.SSH_PUBLIC_PREFIX, ***REMOVED***password)
