        ...
        def prepare_key(self, key: AllowedRSAKeys | str | bytes) -> AllowedRSAKeys:
            ...
            try:
                if key_bytes.startswith(b"ssh-rsa"):
                    ...
                    return cast(
                        RSAPrivateKey, load_pem_private_key(key_bytes, ***REMOVED***None)
                    )
            except ValueError:
                try:
    ...
    class ECAlgorithm(Algorithm):
        ...
        def prepare_key(self, key: AllowedECKeys | str | bytes) -> AllowedECKeys:
            ...
            try:
                ...
                crypto_key = load_pem_private_key(key_bytes, ***REMOVED***None)  # type: ignore[assignment]
        ...
        def prepare_key(self, key: AllowedOKPKeys | str | bytes) -> AllowedOKPKeys:
            if isinstance(key, (bytes, str)):
                ...
                if "-----BEGIN PUBLIC" in key_str:
                    ...
                    key = load_pem_private_key(key_bytes, ***REMOVED***None)  # type: ignore[assignment]
