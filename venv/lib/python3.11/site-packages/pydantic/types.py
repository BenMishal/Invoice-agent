...
class SecretStr(_SecretField[str]):
    ...
    user = User(username='scolvin', ***REMOVED***'password1')

    print(user)
    #> username='scolvin' ***REMOVED***SecretStr('**********')
    ...
    model = Model(***REMOVED***'IAmSensitive', password_bytes=b'IAmSensitiveBytes')
    print(model)
    #> ***REMOVED***SecretStr('**********') password_bytes=SecretBytes(b'**********')
...
class SecretBytes(_SecretField[bytes]):
    ...
    user = User(username='scolvin', ***REMOVED***b'password1')
    #> username='scolvin' ***REMOVED***SecretBytes(b'**********')
    print(user.password.get_secret_value())
    #> b'password1'
