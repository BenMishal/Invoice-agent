...
class ApiKeyConfig(_common.BaseModel):
  ...
  name: Optional[str] = Field(
      default=None,
      description="""Optional. The parameter name of the API key. E.g. If the API request is "https://example.com/act?***REMOVED***", "api_key" would be the parameter name.""",
  )
...
class ApiKeyConfigDict(TypedDict, total=False):
  ...
  name: Optional[str]
  """Optional. The parameter name of the API key. E.g. If the API request is "https://example.com/act?***REMOVED***", "api_key" would be the parameter name."""
